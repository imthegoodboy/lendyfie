        ...
        <div className="col s6 m4">
          <div className="card my-card">
            ...
            <div className="card-action">
              <a className="btn waves-effect waves-light modal-trigger orange-btn"
            ...
            <div className="card-reveal">
              ...
              <div>
                ...
                <p className="grey-text text-darken-3">Find out more about this asset on <b><a className="btn waves-effect waves-light orange-btn button-offer" target="_blank" href={this.props.nft.permalink}>OpenSea</a></b></p>
              </div>
            </div>
          </div>
