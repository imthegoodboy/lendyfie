    ...
    render() {
      return (
        <div className="container">
          <h4 className="card-asset-content page-title-margin card-asset-content">
          ...
          <div className="left-align">
            ...
            <div className="row">
                <button className="btn orange-btn button-offer right" onClick={ this.approveNFT }><i class="material-icons left">looks_one</i> Approve Transfer</button>
            </div>
            <div className="row">
                <button className="btn orange-btn button-offer right" onClick={ this.newLoanRequest }><i class="material-icons left">looks_two</i> Create Request</button>
            </div>
          </div>
        </div>
      )
