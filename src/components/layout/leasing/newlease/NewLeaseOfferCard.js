  ...
  render() {
    return (
      <div className="container">
        <h4 className="page-title-margin card-asset-content">
        ...
        <div className="left-align">
          ...
          <div className="row">
              <button className="btn waves-effect waves-light orange-btn button-offer right" onClick={ this.approveNFT }><i class="material-icons left">looks_one</i> Approve Transfer</button>
          </div>
          <div className="row">
              <button className="btn waves-effect waves-light orange-btn button-offer right" onClick={ this.leaseNFTButton }><i class="material-icons left">looks_two</i> Create Offer</button>
          </div>
        </div>
      </div>
    )
